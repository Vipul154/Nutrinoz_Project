                        ...
                        <div class="div2">
                            ...
                            <div class="signup-form" style="padding-top:0px;">
                                <form method="post" action="" class="login-input">
                                    <span class="error" style="font-size:14px;">
                                    ...
                                    <input type="password" name="password" id="password" placeholder="password"
                                        required /><br>
                                    <div>
                                        <div class="col-md-4 col-sm-5 col-xs-4" style="padding-left:0px;"><input
                                                type="checkbox" name="terms" id="terms" value="remember me"
                                                checked /><span class="policy">Remember me</span></div>
                                        <div class="col-md-6 col-sm-7 col-xs-8"><a href="forgot-password.php"
                                                class="forgot-pass" style="color:#999;">Forgot Password?</a></div>
                                        <div class="clear-crowd"></div>
                                    </div>
                                    <input type="submit" name="login_submit" id="login_submit" value="LOGIN" />
                                    <div class="col-md-12 login-link" style="padding-left:0px;"><span>Want to join
                                            Nutrinoz? <a href="join-us.php" class="up-log">Join-Us</a></span></div>
                                </form>
                                <div class="clear-crowd"></div>
                            </div>
                        </div>

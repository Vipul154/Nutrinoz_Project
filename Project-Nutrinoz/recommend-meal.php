            ...
            <div class="header-section nv">
                ...
                <div class="outer-div">
                    <div class="inner-div">
                        <div class="n-brand">
                            <div class="n-logo">
                                <a href="index.php"><img src="images/logo_new_icon.png" class="nv-logo"
                                        alt="Nutrinoz-logo" /></a>
                            </div>
                        </div>
                        <div class="n-menu">
                    ...
                    <div class="n2-id">
                        ...
                        <div class="col-md-7 col-sm-7 col-xs-6">
                            <div class="n2-all-info">
                                <div class="col-xs-7">
                                    <span class="nutri">Calories: </span><span class="i-data">
                                        <?php echo $dietData['diet_cal_amount']; ?>kCal
                                    </span><br>
                                    <span class="nutri">Carbs: </span><span class="i-data">
                                        <?php echo $dietData['carbs']; ?>g
                                    </span><br>
                                    <span class="nutri">Protein: </span><span class="i-data">
                                        <?php echo $dietData['protein']; ?>g
                                    </span><br>
                                    <span class="nutri">Fat: </span><span class="i-data">
                                        <?php echo $dietData['fat']; ?>g
                                    </span><br>
                                    <span class="nutri">Cost: </span><span class="i-data">
                                        <?php echo $dietData['cost']; ?>/day
                                    </span><br>
                                </div>
                                <div class="col-xs-5">
                                    <div class="more-info"><a href="#totalCal" role="button" data-toggle="modal">Detail Info</a>
                                    </div>
                                </div>
                                <div class="clear-crowd"></div>
                            </div>
                            ...
                            for ($i = 1; $i <= $total_meal; $i++) {
                                ...
                                <div class="meal-1">
                                    <div class="col-md-9 col-sm-9 meal-desc">
                                        <div class="inner-div">
                                            <div class="meal-name">
                                                <div class="col-xs-3" style="padding-left:0;">Meal -
                                                    <?php echo $i; ?>
                                                </div>
                                                <div class="col-xs-5"><a href="#"><img src="images/change.png"
                                                            style="max-width:100%;" /></a></div>
                                                <div class="col-xs-1"></div>
                                                <div class="col-xs-3"><a href="#eachMeal<?php echo $i; ?>" role="button"
                                                        data-toggle="modal">Detail info</a></div>
                                                <div class="clear-crowd"></div>
                                            </div>
                                            <?php
                                            ...
                                            while ($dietMealData = mysqli_fetch_array($diet_meal)) {
                                                ...
                                                <div class="meal-detail">
                                                    <div class="meal-no">
                                                        <div class="col-xs-2" style="padding-left:0;"><img
                                                                src="diet_images/<?php echo $dietMealData['meal_img']; ?>"
                                                                style="max-width:100%;"></div>
                                                        <div class="col-xs-6 padd"><a href="#mealCal" role="button" data-toggle="modal">
                                                                <?php echo $dietMealData['meal_name']; ?>
                                                            </a></div>
                                                        <div class="col-xs-2 padd">
                                                            <?php echo $dietMealData['meal_quantity']; ?>
                                                        </div>
                                                        <div class="col-xs-2 padd">
                                                            <?php echo $dietMealData['meal_cal']; ?> kCal
                                                        </div>
                                                        <div class="clear-crowd"></div>
                                                    </div>
                                                </div>
                                    ...
                                    while ($dietMealData = @mysqli_fetch_array($diet_meal)) {
                                        ...
                                        <div class="col-md-3 col-sm-3 meal-pie">
                                            <div class="n3-dp-pie" id="specMeal">
                                                <span class="nutri">Calories: </span><span class="i-data">
                                                    <?php echo $dietMealData['cal']; ?>kCal
                                                </span><br>
                                                <span class="nutri">Carbs: </span><span class="i-data">
                                                    <?php echo $dietMealData['carbs']; ?>g
                                                </span><br>
                                                <span class="nutri">Protein: </span><span class="i-data">
                                                    <?php echo $dietMealData['protein']; ?>g
                                                </span><br>
                                                <span class="nutri">Fat: </span><span class="i-data">
                                                    <?php echo $dietMealData['fat']; ?>g
                                                </span><br>
                                                <span class="nutri">Cost: </span><span class="i-data">
                                                    <?php echo $dietMealData['cost']; ?>/day
                                                </span><br>
                                            </div>
                                        </div>

...
<body>
    ...
    <div class="profile-section1 ps1">
        <div class="user1">
            ...
            <a href="diet-plan.php"><img src="images/p-right-arrow.png" width="20px" height="20px" />Get your own diet
                Plan</a>
        </div>
    </div>
            ...
            <div class="outer-div">
                <div class="col-md-4 col-sm-4 col-xs-4">
                    ...
                    <div id="f-circle"><strong class="circle-strong1">
                            <?php echo @$info['user_bmi']; ?><br>kg/m<sup>2</sup>
                        </strong></div>
                </div>
                <div class="col-md-4 col-sm-4 col-xs-4">
                    <div>
                    ...
                    <div id="s-circle"><strong class="circle-strong2">
                            <?php echo @$info['user_calories']; ?> <br><span class="center1">kCal</span>
                        </strong></div>
                </div>
                <div class="col-md-4 col-xs-4">
                    ...
                    <div id="t-circle"><strong class="circle-strong3">
                            <?php echo @$info['user_ideal_weight']; ?> <br><span class="center2">Kg</span>
                        </strong></div>
                </div>

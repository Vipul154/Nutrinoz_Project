                            ...
                            <div class="signup-form">
                                <form method="post" action="" id="signup_first">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="checkbox" name="terms" id="terms" value="agreed" checked /><span
                                            class="policy">By signing up,I agree to your terms and conditions</span><br>
                                        <span class="error" style="margin-top:0px;">
                                            <?php echo @$checkbox_error; ?>
                                        </span><br>
                                    </div>
                                    <div class="col-md-6">
                                        <input type="submit" name="signup_submit" id="signup_submit" value="SIGN UP" />
                                    </div>
                                    <div class="col-md-12 login-link"><span>Already have an account? <a href="login.php"
                                                class="up-log">Login</a></span></div>

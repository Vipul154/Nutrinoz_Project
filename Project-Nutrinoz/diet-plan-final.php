...
<body>
    ...
    <div class="container-fluid">
        <div class="n1-d-f-content">
            <div class="plan">
                ...
                <a href="diet-result.php" class="btn btn-primary">Get It Now</a>
            </div>
        </div>
    </div>
    <div class="bmi-section">
        <div class="bmi">
            ...
            <div class="col-md-3">
                <h5> Suggestion</h5>
                <span class="div3">Your BMI is within the norm. Please calculate your BMI regularly and consult your
                    physician when it is lower and upper the norm.</span>
            </div>
    ...
    <div class="calorie-section">
        <div class="calorie">
            ...
            <div class="col-md-3 div-c">
                ...
                <span class="div1"><b>
                        <?php echo round($cal, 0) - 100; ?> -
                        <?php echo round($cal, 0) + 100; ?> kCal
                    </b></span>
            ...
            <div class="col-md-6">
                ...
                <div class="cal-result">
                    <p>You have a BMR of
                        <?php echo round($bmr, 0); ?>.
                    </p>
                    <p>You need
                        <?php echo round($cal, 0); ?> Calories/day to maintain your weight.
                    </p>
                    <p>You need
                        <?php echo round($cal, 0) + 500; ?> Calories/day to gain 0.5 kg per week.
                    </p>
                    <p>You need
                        <?php echo round($cal, 0) + 1000; ?> Calories/day to gain 1 kg per week.
                    </p>
                    <p>You need
                        <?php echo round($cal, 0) - 500; ?> Calories/day to lose 0.5 kg per week.
                    </p>
                    <p>You need
                        <?php echo round($cal, 0) - 1000; ?> Calories/day to lose 1 kg per week.
                    </p>
                </div>
            </div>
            <div class="col-md-3">
                <h5>Suggestion</h5>
                <span class="div3">Try not to lower your calorie intake by more than 1,000 calories per day, and try to
                    lower your calorie intake gradually, but not more than 1000 below your maintenance level.</span>
            </div>
            <div class="clear-crowd"></div>
        </div>
    </div>
    <div class="idwt-section">
        <div class="idwght">
            ...
            <div class="col-md-3 div-i">
                ...
                <p class="div1"><b>
                        <?php echo $bmi_ideal_weight_range1; ?> kgs -
                        <?php echo $bmi_ideal_weight_range2; ?> kgs
                    </b></p>
            </div>
            <div class="col-md-6">
                <h5>Result</h5>
                <div class="iw-result">
                    <p>Based on the Robinson formula your ideal weight is
                        <?php echo $rob_ideal_weight; ?> kgs
                    </p>
                    <p>Based on the Miller formula your ideal weight is
                        <?php echo $mil_ideal_weight; ?> kgs
                    </p>
                    <p>Based on the Devine formula your ideal weight is
                        <?php echo $dev_ideal_weight; ?> kgs
                    </p>
                    <p>Based on the Hamwi formula your ideal weight is
                        <?php echo $ham_ideal_weight; ?> kgs
                    </p>
                </div>
            </div>
            <div class="col-md-3">
                <h5>Suggestion</h5>
                <span class="div3">This is the weight that other people of the same height and at the same age consider
                    perfect.</span>
            </div>
            <div class="clear-crowd"></div>
        </div>

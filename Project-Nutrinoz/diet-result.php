...
<body>
    ...
    <?php include('diet-plan-final.php'); ?>
        ...
        <div class="data-all">
            <div class="outer-div">
                <div class="col-md-4 col-sm-4 col-xs-4">
                    ...
                    <div id="f-circle"><strong class="circle-strong1">
                            <?php echo $bmi; ?><br>kg/m<sup>2</sup>
                        </strong></div>
                </div>
                <div class="col-md-4 col-sm-4 col-xs-4">
                    <div>
                    ...
                    <div id="s-circle"><strong class="circle-strong2">
                            <?php echo $cal_range; ?> <br><span class="center1">kCal</span>
                        </strong></div>
                </div>
                <div class="col-md-4 col-xs-4">
                    ...
                    <div id="t-circle"><strong class="circle-strong3">
                            <?php echo $bmi_ideal_weight_range; ?> <br><span class="center2">Kg</span>
                        </strong></div>
                </div>
        ...
        <div class="outer-div">
            ...
            <div class="part2">
                <div class="col-sm-4 col-md-4 col-xs-4">
                    <div class="inner-div">
                        <a
                            href="recommend-meal.php?v1=<?php echo $ntype; ?>&v2=<?php echo $meal_num; ?>&v3=<?php echo $recommend; ?>">
                            <div class="title">
                                <h3>Diet Plan 1 -
                                    <?php echo $recommend; ?> kCal
                                </h3>
                            </div>
                ...
                <div class="col-sm-4 col-md-4 col-xs-4">
                    <div class="inner-div">
                        <a
                            href="recommend-meal.php?v1=<?php echo $ntype; ?>&v2=<?php echo $meal_num; ?>&v3=<?php echo $recommend + 100; ?>">
                            <div class="title">
                                <h3>Diet Plan 2 -
                                    <?php echo $recommend + 100; ?> kCal
                                </h3>
                            </div>
                ...
                <div class="col-sm-4 col-md-4 col-xs-4">
                    <div class="inner-div">
                        <a
                            href="recommend-meal.php?v1=<?php echo $ntype; ?>&v2=<?php echo $meal_num; ?>&v3=<?php echo $recommend + 200; ?>">
                            <div class="title">
                                <h3>Diet Plan 3 -
                                    <?php echo $recommend + 200; ?> kCal
                                </h3>
                            </div>
